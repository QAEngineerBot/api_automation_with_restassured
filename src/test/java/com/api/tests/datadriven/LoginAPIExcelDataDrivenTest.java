...
public class LoginAPIExcelDataDrivenTest {
	...
	@Test(groups = { "api", "smoke",
			"regression" }, dataProviderClass = com.dataproviders.DataProviderUtils.class, dataProvider = "LoginExcelDataProvider")
	public void loginAPITest(LoginRequestBean loginBean) {
		given().spec(requestSpec(loginBean)).when().post("login").then().spec(successResponseSpec()).log()
