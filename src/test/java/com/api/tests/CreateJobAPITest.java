...
public class CreateJobAPITest {
    ...
    CustomerAddress customerAddress= new CustomerAddress("1","AG","MG","PG","pune","411052","India","Maharashtra");
    CustomerProduct customerProduct= new CustomerProduct("2025-09-23T18:30:00.000Z","12349846994895","12349846994895","12349846994895","2025-09-23T18:30:00.000Z",3,3);
    Problems problems[]= {new Problems(1,"Problem 1")};
    CreateJobApiRequest createJobApiRequest= new CreateJobApiRequest(0,2,1,2,customer,customerAddress,customerProduct,problems);
