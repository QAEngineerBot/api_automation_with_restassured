...
public class CreateJobAPIMapper {

	public static CreateJobApiRequest mapper(CreateJobBean bean) {
		...
		int warrantyId = Integer.parseInt(bean.getMst_warrenty_status_id());
		...
		CreateJobApiRequest createJobPayload = new CreateJobApiRequest(serviceLocationId, platformId, warrantyId, oemId,
