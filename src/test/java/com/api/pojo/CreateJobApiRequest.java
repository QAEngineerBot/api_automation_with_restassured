...
public class CreateJobApiRequest {
    ...
    public CreateJobApiRequest(int mst_service_location_id, int mst_platform_id, int mst_warrenty_status_id,
    ...
    public String toString() {
        return "CreateJobApiRequest [mst_service_location_id=" + mst_service_location_id + ", mst_platform_id="
